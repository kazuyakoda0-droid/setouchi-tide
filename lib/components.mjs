...
// ---------------------------------------------------------------------
// 気象・海象（Open-Meteo をクライアントで取得して埋める）
// ---------------------------------------------------------------------
export function weatherBlock(st, ymd) {
  return `<div class="wx" data-wx data-lat="${st.lat}" data-lon="${st.lon}" data-date="${attr(ymd)}">
  <p class="wx-load">気象・海象データを読み込んでいます…</p>
</div>`;
}
