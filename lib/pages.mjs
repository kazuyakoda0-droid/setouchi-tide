...
<article>
  <header class="home-hd">
    ...
    <nav class="home-purpose" aria-label="用途から探す"><span>目的から探す</span>${activities.map(a =>
      `<a href="${attr(paths.activity(a.slug))}">${esc(a.title.replace('の潮見表・タイドグラフ', ''))}</a>`).join('')}</nav>
  </header>
  <div id="areas"></div>
