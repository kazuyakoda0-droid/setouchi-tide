...
<article>
  ...
  <div class="split pin">
    ...
    <div class="split-map">
      <div class="map" data-map data-stations="${attr(JSON.stringify(rows.map(x => ({
...
<article>
  ...
  <div class="split">
    ...
    <div class="split-map">
      <div class="map tall" data-map data-fit="japan" data-stations="${attr(JSON.stringify(allStations.map(s => ({
        n: s.name, la: s.lat, lo: s.lon, h: paths.station(s), o: s.jmaAnchor ? 0 : 1,
      }))))}"></div>
