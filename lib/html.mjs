...
<link rel="stylesheet" href="${attr(asset('style.css?v=coastal-20260911-6'))}">
${opts.head || ''}
...
${siteFooter()}
${opts.scripts || ''}
<script src="${attr(asset('app.js?v=touch-20260911-2'))}" defer></script>
</body>
</html>`;
}
...
function siteHeader(headerArt) {
  ...
  <nav class="site-nav">
    ...
    <button type="button" class="favorite-nav" data-search-open data-search-src="${attr(asset('stations-index.json'))}" aria-label="お気に入りの地点を見る"><span aria-hidden="true">★</span> お気に入り</button>
