...
<body${cls ? ` class="${attr(cls)}"` : ''}${opts.fileBase ? ` data-file="${attr(opts.fileBase)}"` : ''}${opts.recentStation ? ` data-recent="${attr(JSON.stringify(opts.recentStation))}"` : ''}>
${siteHeader()}
<main>
...
function searchOverlay() {
  ...
  <div class="search-panel" role="dialog" aria-modal="true" aria-label="地点を検索">
    <div class="search-bar">
      ...
      <button type="button" class="search-close" data-search-close aria-label="閉じる">✕</button>
    </div>
