...
<body${opts.bodyClass ? ` class="${attr(opts.bodyClass)}"` : ''}${opts.fileBase ? ` data-file="${attr(opts.fileBase)}"` : ''}>
${siteHeader()}
<main>
...
function siteFooter() {
  ...
  <div class="src">
    ...
    <p>気象・海象データは<a href="${attr(SITE.OM_CREDIT_URL)}" rel="nofollow noopener" target="_blank">${esc(SITE.OM_CREDIT)}</a>によります。</p>
