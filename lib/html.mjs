...
<meta name="theme-color" content="#f3f8f7" media="(prefers-color-scheme: light)">
...
export function waveMark(idPrefix, className) {
  return `<svg class="${attr(className)}" viewBox="0 0 64 64" aria-hidden="true">`
    + `<defs><radialGradient id="${idPrefix}g" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#55d5cd"/><stop offset="100%" stop-color="#087b8f"/></radialGradient>`
